"""
Test version of admin router without authentication for testing.
"""
...
# Create a test router without authentication dependencies
router = APIRouter()


@router.get("/content-tree", response_model=List[ContentNode])
async def get_content_tree(cs_service: ContentScannerService = Depends(get_content_scanner)):
...
async def get_config_file(
    ...
    from src.dependencies import validate_safe_path
